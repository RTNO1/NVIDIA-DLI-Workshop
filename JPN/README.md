...
### 受講資格：
1. 「関数，ループ，辞書，配列などのPython の基礎的なプログラミング概念, 及び回帰直線を計算する方法」を理解する
2. 以下に示す要件を満すハードウェアを持つ
3. ワークショップの全行程に参加できる<br>
学部３回生以上か大学院生
### ハードウェア要件: 
クラウドに置かれているGPU対応サーバーに安定してアクセスできるネットワーク環境，および最新版の Chrome または Firefox を実行できるデスクトップコンピューターまたはノートPC
### 無料受講登録：
