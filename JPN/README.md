...
### 受講資格：
「関数，ループ，辞書，配列などのPython の基礎的なプログラミング概念, 及び回帰直線を計算する方法」を理解しており，以下に示すハードウェア要件を満す学部３回生以上か大学院生，かつ「ワークショップの全行程に参加できること」
### ハードウェア要件: 
クラウドに置かれているGPU対応サーバーに安定してアクセスできるネットワーク環境，および最新版の Chrome または Firefox を実行できるデスクトップコンピューターまたはノートPCを有すること
### 無料受講登録：
